...
/**
 * Converts newline characters (or newline + comma) to comma + space.
 * Useful for converting multi-line address to single line.
 *
 * @param string $str
 * @return string
 */
...
/**
 * Converts newline and tab characters to backslash codes.
 * Useful for copying strings containing special whitespace characters from the server to client-side JavaScript variables.
 *
 * @param string $str
 * @return string
 */
...
function numberToWords($num)
{
	...
	// NEEDS UPDATING - provide support for either American or UK billions, trillions, etc.
...
/**
 * Converts all /'s into the directory path character (e.g. if needed to form a Windows path).
 *
 * @param string $path
 * @return string
 */
